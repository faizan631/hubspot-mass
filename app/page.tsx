      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-8">
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-red-700 text-sm">{decodeURIComponent(error as string)}</p>
                <p className="text-red-600 text-xs mt-1">Please try signing in again below.</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Backup & Sync Your{" "}
            <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">HubSpot</span>{" "}
            Pages Safely
          </h1>

          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Automatically backup your HubSpot pages to Google Sheets with one-click rollback, change tracking, and
            team-safe editing. Never worry about losing content again.
          </p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Built specifically for HubSpot users who need reliable backup and safe content management.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Automatic Daily Backups</h3>
                  <p className="text-gray-600">
                    Schedule automatic backups to Google Sheets with change detection. Only backup what's changed to
                    save space and time.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Instantly revert any change to any previous version. See exactly what changed and when with detailed
                    change tracking.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Mark dangerous fields as read-only, validate changes before they go live, and track who changed what
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    All your backups stored in familiar Google Sheets. Easy to share, analyze, and manage with your
                    existing workflow.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Trusted by 500+ HubSpot users</p>
                </div>
              </div>
              <blockquote className="text-gray-700 italic">
                "Smuves saved us when we accidentally deleted our entire homepage. One-click restore and we were back
                online in minutes!"
              </blockquote>
              <cite className="text-sm text-gray-500 mt-2 block">— Sarah Chen, Marketing Director</cite>
            </div>
          </div>
        ...
        <div className="mt-20 text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Join hundreds of teams who trust Smuves to keep their HubSpot content safe and recoverable.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-600 text-sm">The safest way to backup and manage your HubSpot content.</p>
            </div>
