  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      toast({
        title: "Coming Soon! 🚀",
        description:
          "Premium features will be available soon. We'll notify you when ready!",
      });
  ...
  const premiumFeatures = [
    {
      ...
      description:
        "One-click rollback to any previous version with detailed change tracking",
      category: "Recovery",
    },
    {
      ...
      description:
        "Automatic backups every day with 30-day retention and change detection",
      category: "Automation",
    },
    {
      ...
      description:
        "Detailed reports on changes, usage patterns, and content performance",
      category: "Analytics",
    },
    {
      ...
      description:
        "Custom validation rules and approval workflows for sensitive changes",
      category: "Safety",
    },
    {
    ...
    },
    {
      ...
      description:
        "Sync blogs, landing pages, redirects, and other HubSpot content types",
      category: "Content",
    },
  ];
    ...
    <div className="space-y-6">
      ...
      >
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Crown
              className={`h-5 w-5 ${
                userSettings.is_premium ? "text-yellow-600" : "text-gray-400"
              }`}
            />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Advanced capabilities to make your content management safer and more
            efficient
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          >
            ...
            <CardContent className="space-y-4">
              ...
              {plan.limitations.length > 0 && (
                <div className="space-y-2">
                  <h4 className="font-medium text-gray-600">Limitations:</h4>
                  <ul className="space-y-1">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            See how Premium features save you time and reduce risks
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <ul className="text-sm space-y-1">
              ...
              <li>
                • Enables non-technical team members to manage content safely
              </li>
            </ul>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <h4 className="font-medium">
              What happens to my backups if I downgrade?
            </h4>
            <p className="text-sm text-gray-600">
              Your existing backups will remain accessible, but automatic
              backups will stop. You can still create manual backups on the Free
              plan.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600">
              No setup fees. Premium features are activated immediately upon
              upgrade.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600">
              Team features and discounts will be available in a future update.
