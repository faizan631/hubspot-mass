    ...
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Select
                    value={selectedBackupSheet}
                    onValueChange={setSelectedBackupSheet}
                  >
                  ...
                  <Button
                    onClick={saveBackupSheet}
                    disabled={!selectedBackupSheet}
                  >
                    Save
                  </Button>
                </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect your HubSpot account using a private app token
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {!hubspotConnected ? (
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-green-700 mt-1">
              You can now sync pages, create backups, and manage your HubSpot
              content through Google Sheets.
            </p>
          </CardContent>
        </Card>
      )}
